...
<div class="home-section">
  ...
  <div class="leadership-org">
    <div class="leadership-org__name">📡 IEEE Signal Processing Society</div>
    <div class="leadership-role"><span class="role-title">Editor – SPS Newsletter Magazine</span><span class="role-date">2025</span></div>
  </div>
  ...
  <div class="leadership-org">
    ...
    <div class="leadership-role"><span class="role-title">Content Writer – Marketing & PR (Summer 23.24)</span><span class="role-date">2023</span></div>
    <div class="leadership-role"><span class="role-title">OC Member – Marketing – HOPE 2023</span><span class="role-date">2023</span></div>
  </div>
  ...
  <div class="leadership-org">
    ...
    <div class="leadership-role"><span class="role-title">OC Member – Delegates – SLRC 2024</span><span class="role-date">2024</span></div>
  </div>

  <div class="leadership-org">
    <div class="leadership-org__name">🏫 Electronic Society — Sirimavo Bandaranaike Vidyalaya</div>
    <div class="leadership-role"><span class="role-title">Secretary</span><span class="role-date">2020 – 2021</span></div>
  </div>
</div>
...
<div class="home-section">
  ...
  <ul class="cert-list">
    ...
    <li>📐 Curve Fitting Onramp <span class="cert-provider">MathWorks · Aug 2024</span></li>
    <li>🖼️ Deep Learning Onramp <span class="cert-provider">MathWorks · Aug 2024</span></li>
    <li>📷 Computer Vision Onramp <span class="cert-provider">MathWorks · Jul 2024</span></li>
    <li>🖼️ Image Processing Onramp <span class="cert-provider">MathWorks · Jun 2024</span></li>
    <li>📡 Signal Processing Onramp <span class="cert-provider">MathWorks</span></li>
  </ul>
</div>

<script>
(function() {
  var words = ["Computational Biology", "Genomics", "Medical AI", "Molecular Dynamics", "Bioinformatics", "Biomedical Engineering"];
  var idx = 0;
